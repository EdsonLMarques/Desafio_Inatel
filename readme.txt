...
- Utilize um repositório (github, gitlab) para publicar seu código e nos enviar.

objetivos
(OK) Cadastro de imóveis
(OK) Cadastro de clientes
(OK) Listagem dos imóveis
(OK) Registro de locação
(OK) Listagem de imóveis locados
...
informações:
    ...
    Teste = Não
    layout = bootstrap com partes de html e css manuais
    API = Não
    repositório = github
